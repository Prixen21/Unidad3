...
public class e1 {
    ...
    public static void AsignaValores(double[][] matriz ) {
        ...
        for (int f = 0; f < 4; f++){
            ...
            for(int c = 0; c<3; c++){
                System.out.print("Asigna el valor del alumno " + (f + 1) + " En el examen "+ (c + 1));
    ...
    public static void MuestraValores(double[][] matriz) {
        for(int f = 0; f<4; f++){
            for(int c = 0; c<4; c++){
                if(c == 3){
                    System.out.printf("El alumno %d Tiene una media de  %.2f", (f + 1), matriz[f][c]);
                    System.out.println();
                    System.out.println();

                }else{
                System.out.printf("El alumno %d en su examen nº %d ha sacado un %.2f", (f + 1), (c + 1 ), matriz[f][c]);
                System.out.println();}
            }
        }
    }
